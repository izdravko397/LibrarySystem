...
import LibrarySystem.library.validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_date', models.DateField(validators=[LibrarySystem.library.validators.validate_published_date])),
                ('isbn', models.CharField(help_text='13 digits', max_length=13, unique=True, validators=[LibrarySystem.library.validators.validate_isbn])),
